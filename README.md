...
Grab `Grok-Desktop-*-universal.dmg` from [Releases](https://github.com/thaikolja/grok-desktop-app-for-macos/releases). Open it, drag **Grok Desktop** into Applications.
